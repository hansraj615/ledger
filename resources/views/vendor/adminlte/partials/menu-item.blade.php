...
@else
    <li class="{{ $item['class'] }}">
        ...
        >
            <i class="{{ $item['icon'] ?? 'far fa-fw fa-circle' }} {{ isset($item['icon_color']) ? 'text-' . $item['icon_color'] : 'warning' }}"></i>
            <span>
                {{ $item['text'] }}
            </span>
            ...
            @if (isset($item['label']))
                <span class="pull-right-container">
                    <span class="label label-{{ $item['label_color'] ?? 'warning' }} pull-right">{{ $item['label'] }}</span>
                </span>
