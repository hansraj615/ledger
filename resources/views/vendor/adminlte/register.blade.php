        ...
        <div class="register-box-body">
            ...
            <form action="{{ url(config('adminlte.register_url', 'register')) }}" method="post">
                ...
                <div class="form-group has-feedback {{ $errors->has('name') ? 'has-error' : '' }}">
                    <input type="text" name="name" class="form-control form-rounded" value="{{ old('name') }}"
                ...
                <div class="form-group has-feedback {{ $errors->has('password_confirmation') ? 'has-error' : '' }}">
                    <input type="password" name="password_confirmation" class="form-control form-rounded"
            ...
            <br>
            <p>
                <a href="{{ url(config('adminlte.login_url', 'login')) }}" class="text-center text-white">
